        ...
        <header>
            ...
            <div class="live-badge">
                <%
                    ...
                    java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat("E, dd MMM yyyy HH:mm:ss z");
                    String formattedDate = formatter.format(currentDate);
                    out.println(formattedDate);
                    //out.println("<p><strong>Current Time:</strong> " + formattedDate + "</p>");
                %>
            </div>
            <div class="live-badge">
                <span class="dot"></span>
                    ...
                    strikePrices.forEach(strike => {
                        ...
                        if (oiDataMap[strikeKey]) {
                            ...
                            if (priceTrend === 'UP') {
                                ...
                                //Newly added - Puts Rel Change [10%, 15%] and Call Rel Change >= [-5%] and pcr is greater than 1.
                                if (relCChange15 >= -5 && (relPChange15 >= 10 || relPChange5 <= 15) && pcr > 1) {
                                    signals.push('15m: BUY CALL @ ' + cInfo.current_price.toFixed(2));
                                    rowClass = "signal-call";
                                }
                                ...
                                // if PCR gets unbalanced for 15 min
                                if (pcr <= 0.6 && (relCChange15 <= -10 && (relPChange15 >= 5 || relPChange5 >= 10))) {
