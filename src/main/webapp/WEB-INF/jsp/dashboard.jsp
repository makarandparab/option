<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false" %>
    ...
    <head>
        ...
        <style>
            ...
            tr.highlight-orange:hover {
                background-color: rgba(251, 146, 60, 0.3);
            }

            tr.highlight-light-pink {
                background-color: rgba(244, 114, 182, 0.2);
            }

            tr.highlight-light-pink:hover {
                background-color: rgba(244, 114, 182, 0.3);
            }

            tr.highlight-light-red {
                background-color: rgba(252, 165, 165, 0.3);
            }

            tr.highlight-light-red:hover {
        ...
        <script>
            ...
            function renderPage() {
                try {
                    ...
                    // First pass: find the absolute highest Call OI% and Put OI%
                    ...
                    strikePrices.forEach(strike => {
                        ...
                        if (oiDataMap[strikeKey]) {
                            ...
                            let isHighestCall = (cChangeP === maxCallOiP && maxCallOiP > 0);
                            let isHighestPut = (pChangeP === maxPutOiP && maxPutOiP > 0);

                            // Determine if increasing or decreasing over last 5 mins
                            let isCallIncreasing = (cChangeP > last5MinCallOiChgP);
                            let isCallDecreasing = (cChangeP < last5MinCallOiChgP);
                            let isPutIncreasing = (pChangeP > last5MinPutOiChgP);
                            let isPutDecreasing = (pChangeP < last5MinPutOiChgP);
